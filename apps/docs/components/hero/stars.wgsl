...
fn starLayer(
  ...
  // Measured in GRID units: `grid` runs to `cells` (210 on the finest layer)
  // while `radius` is ~0.06, so the subtraction needs the f32 mantissa to
  // resolve a point at all.
