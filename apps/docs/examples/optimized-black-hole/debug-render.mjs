...
//
//   node apps/docs/examples/optimized-black-hole/debug-render.mjs
//   node apps/docs/examples/optimized-black-hole/debug-render.mjs --size 960x540 --time 4
//   node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final,flags
//   node apps/docs/examples/optimized-black-hole/debug-render.mjs --disk.stretch 3 --disk.detail 1.6
//   node apps/docs/examples/optimized-black-hole/debug-render.mjs --set '{"disk":{"brightness":2}}'
