...
| `index.tsx` | infrastructure | only to add a GUI row for a new field |
...
3. `index.tsx` — add one `folder.add(settings.disk, 'name', min, max, step)` row.
...
node apps/docs/examples/optimized-black-hole/debug-render.mjs                        # all views, 1280x720
node apps/docs/examples/optimized-black-hole/debug-render.mjs --size 960x540 --time 4
node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final,density
node apps/docs/examples/optimized-black-hole/debug-render.mjs --disk.stretch 3 --disk.detail 1.6
node apps/docs/examples/optimized-black-hole/debug-render.mjs --stars.density 2 --stars.contrast 40
node apps/docs/examples/optimized-black-hole/debug-render.mjs --diskRadius 12 --cameraY 0.3
node apps/docs/examples/optimized-black-hole/debug-render.mjs --set '{"disk":{"brightness":2}}' --json
node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final,hit2                 # second-hit check
node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final --diskLayers 1 --out /tmp/before
node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final,raydir --yaw 0.15        # scene rotation
node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final,raydir --bakeYaw -0.15   # its ground truth
node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final,aa --aa 0                # ring AA A/B (off)
node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final --ssaa 3 --out /tmp/ref3x # the AA reference
node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final --crop 740,225,60,60,10   # 10x ring zoom
```
...
>   apps/docs/examples/optimized-black-hole/stars.wgsl
> node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final --size 320x180; echo "exit=$?"
> git checkout apps/docs/examples/optimized-black-hole/stars.wgsl
> # 2. healthy render -> exit 0, PNGs byte-identical to before your change
> # 3. legitimately black -> exit 0
> node apps/docs/examples/optimized-black-hole/debug-render.mjs --views final \
