...
export class CanvasSurface implements Surface {
  ...
  renderPassDescriptor(clear: ClearColor = [0, 0, 0, 1], preserve?: boolean, _clearDepth?: number, _clearStencil?: number): GPURenderPassDescriptor {
    // Surfaces have no depth attachment; clearDepth and clearStencil cannot apply.
    this.#assertLive();
