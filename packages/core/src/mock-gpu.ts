  ...
  const device: InstrumentedGPUDevice = {
    ...
    createCommandEncoder(desc: GPUCommandEncoderDescriptor = {}): GPUCommandEncoder {
      ...
      return {
        ...
        // setBlendConstant is deliberately absent from the mock render bundle encoder above, matching WebGPU.
        beginRenderPass: () => ({ setBindGroup() {}, setVertexBuffer() {}, setIndexBuffer() {}, setPipeline() {}, setBlendConstant() {}, executeBundles() {}, draw() {}, drawIndexed() {}, end() {} }) as unknown as GPURenderPassEncoder,
        finish: () => ({}),
